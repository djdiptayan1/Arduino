...
void loop() {
  ...
  // Read analog input from a pin
  int analogValue = 255; // Replace with the appropriate analog pin

  // Prepare HTTP GET request with the digital and analog values
  String request = "GET /updateData?digital=" + String(digitalValue) + "&analog=" + String(analogValue); // Replace with the appropriate endpoint and query parameters
